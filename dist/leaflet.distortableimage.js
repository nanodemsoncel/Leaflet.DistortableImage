!(function (t) {
    ...
    L.DomUtil = L.extend(L.DomUtil, {
      ...
      confirmDeletes: function (t) {
        ...
        var e = this.translation.confirmImagesDeletes,
          i = "";
        return (i = "function" == typeof e ? e(t) : e), window.confirm(i);
      },
    });
  },
  function (t, e) {
  ...
  function (t, e) {
    L.ImageUtil = {
      getCmPerPixel: function (t) {
        ...
        return (
          (100 *
            e.latLngToLayerPoint(t.getCorner(0)).distanceTo(e.latLngToLayerPoint(t.getCorner(1)))) /
          t.getElement().width
        );
      },
    };
  ...
  function (t, e) {
    L.MatrixUtil = {
      ...
      multmm: function (t, e) {
        ...
        for (i = 0; i < 3; i++)
          for (var n = 0; n < 3; n++) {
            for (var a = 0, s = 0; s < 3; s++) a += t[3 * i + s] * e[3 * s + n];
            o[3 * i + n] = a;
          }
        return o;
      },
    ...
    (L.DistortableImageOverlay = L.ImageOverlay.extend({
      ...
      onAdd: function (t) {
        ...
        (this._map = t),
          ...
          L.DomEvent.on(this.getElement(), "load", function () {
            ...
            e._corners ||
              (t.options.zoomAnimation && L.Browser.any3d && t.on("zoomanim", e._animateZoom, e));
            var o = e._eventParents;
            o
              ? ((e.eP = o[Object.keys(o)[0]]), e.eP.editable && e.editing.enable())
      ...
      _initImageDimensions: function () {
        ...
        this.options.corners
          ...
          (this._initialDimensions = { center: s, offset: r, zoom: t.getZoom() }),
      ...
      deselect: function () {
        ...
        if (t.enabled())
          return (
            t._removeToolbar(), t._hideMarkers(), (this._selected = !1), this.fire("deselect"), this
          );
      },
      select: function (t) {
        var e = this.editing,
      ...
      _cornerExceedsMapLats: function (t, e, i) {
        ...
        return (
          0 === t
            ...
            : ((o = i.project(e).y / t < 2), (n = i.project(e).y / Math.pow(2, t) >= 255)),
          o || n
        );
      },
      ...
      setCornersFromPoints: function (t) {
        ...
        for (a in t) (this._corners[n] = e.layerPointToLatLng(t[a])), (n += 1);
        return (
          this.setBounds(L.latLngBounds(this.getCorners())),
          this.fire("update"),
          o.toolbar && o.toolbar instanceof L.DistortableImage.PopupBar && o._updateToolbarPos(),
      ...
      getAngle: function () {
        ...
        return (
          ...
          r < 0 && (r = 2 * Math.PI + r),
          "deg" === t ? Math.round(L.TrigUtil.radiansToDegrees(r)) : L.Util.formatNum(r, 2)
        );
      },
      setAngle: function (t) {
      ...
      rotateBy: function (t) {
        var e,
          i,
          o,
          n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "deg",
          a = this._map,
          s = a.project(this.getCenter()),
          r = {};
        for ("deg" === n && (t = L.TrigUtil.degreesToRadians(t)), e = 0; e < 4; e++)
      ...
      dragBy: function (t, e) {
        ...
        for (i = 0; i < 4; i++)
          (o = n.project(this.getCorner(i)).subtract(s)), (a[i] = n.unproject(o));
        this.setCorners(a);
      },
      restore: function () {
        for (
          var t = this._map,
            ...
            n = [e.subtract(i), e.add(L.point(i.x, -i.y)), e.add(L.point(-i.x, i.y)), e.add(i)],
            a = 0;
          a < 4;
          a++
        )
      ...
      _animateZoom: function (t) {
        ...
        (i._leaflet_pos = a), (i.style[L.DomUtil.TRANSFORM] = [r, s].join(" "));
      },
      getCorners: function () {
  ...
  function (t, e) {
    (L.DistortableCollection = L.FeatureGroup.extend({
      ...
      _addEvents: function (t) {
        var e = t.layer;
        L.DomEvent.on(e, { dragstart: this._dragStartMultiple, drag: this._dragMultiple }, this),
          L.DomEvent.on(
            e.getElement(),
            { mousedown: this._deselectOthers, contextmenu: this._longPressMultiSelect },
            this
          );
      },
      _removeEvents: function (t) {
        var e = t.layer;
        L.DomEvent.off(e, { dragstart: this._dragStartMultiple, drag: this._dragMultiple }, this),
          L.DomEvent.off(
            e.getElement(),
            { mousedown: this._deselectOthers, contextmenu: this._longPressMultiSelect },
            this
      ...
      if (0 !== Object.keys(EXIF.getAllTags(t)).length) {
        ...
        if (void 0 !== e.GPSLatitude && void 0 !== e.GPSLongitude) {
          e.GPSLatitude[0],
            ...
            e.GPSLongitude[1],
            e.GPSLongitude[2];
          "N" !== e.GPSLatitudeRef && -1, "W" === e.GPSLongitudeRef && -1;
        }
        "T" === e.GPSImgDirectionRef || "M" === e.GPSImgDirectionRef
          ? (Math.PI / 180) * (e.GPSImgDirection.numerator / e.GPSImgDirection.denominator - 90)
          ...
          6 === e.Orientation
            ...
            : 8 === e.Orientation
            ? (Math.PI / 180) * 90
            : 3 === e.Orientation && (Math.PI / 180) * 180,
          void 0 !== e.GPSAltitude &&
            void 0 !== e.GPSAltitudeRef &&
            (void 0 !== e.GPSAltitude && void 0 !== e.GPSAltitudeRef
              ? e.GPSAltitude.numerator / e.GPSAltitude.denominator + e.GPSAltitudeRef
              : 0);
  ...
  function (t, e) {
    L.EditHandle = L.Marker.extend({
      ...
      onAdd: function (t) {
        L.Marker.prototype.onAdd.call(this, t), this._bindListeners(), this.updateHandle();
      },
      onRemove: function (t) {
        if (this) {
    ...
    (L.LockHandle = L.EditHandle.extend({
      ...
      _bindListeners: function () {
        ...
        L.EditHandle.prototype._bindListeners.call(this),
          L.DomEvent.on(t, { mousedown: this._tooltipOn, mouseup: this._tooltipOff }, this),
          L.DomEvent.on(document, "pointerleave", this._tooltipOff, this);
      },
      _unbindListeners: function () {
        var t = this.getElement();
        L.EditHandle.prototype._bindListeners.call(this),
          L.DomEvent.off(t, { mousedown: this._tooltipOn, mouseup: this._tooltipOff }, this),
  ...
  function (t, e) {
    (L.DistortableImage = L.DistortableImage || {}),
      ...
      (L.EditAction = L.Toolbar2.Action.extend({
        options: { toolbarIcon: { svg: !1, html: "", className: "", tooltip: "" } },
        initialize: function (t, e, i) {
          (this._overlay = e),
            (this._map = t),
            L.setOptions(this, i),
      ...
      initialize: function (t, e, i) {
        ...
        n instanceof L.DistortableImage.Edit
          ? ((o = e.options.translation.deleteImage),
            (L.DistortableImage.action_map.Backspace = "lock" === n._mode ? "" : "_removeOverlay"))
    ...
    L.ExportAction = L.EditAction.extend({
      initialize: function (t, e, i) {
        ...
        (this.isExporting = !1),
          ...
          ((i = i || {}).toolbarIcon = { svg: !0, html: "get_app", tooltip: o }),
          L.EditAction.prototype.initialize.call(this, t, e, i);
      },
      addHooks: function () {
        var t = this._overlay.editing;
            ...
            L.DomEvent.on(
              ...
              function () {
                if (this.isExporting) {
                  ...
                  this.resetState(), this.detachMouseEventListeners(e), t.cancelExport();
                } else
                  (this.isExporting = !0),
      ...
      initialize: function (t, e, i) {
        ...
        a instanceof L.DistortableImage.Edit
          ...
          : ((L.DistortableImage.group_action_map.l = "_lockGroup"),
            ...
            (o = "lock")),
          ((i = i || {}).toolbarIcon = { svg: !0, html: o, tooltip: n, className: "lock" }),
          L.EditAction.prototype.initialize.call(this, t, e, i);
      },
      addHooks: function () {
        var t = this._overlay.editing;
    ...
    L.OpacityAction = L.EditAction.extend({
      initialize: function (t, e, i) {
        var o,
          ...
          s = a._mode;
        a._transparent
          ? ((o = "opacity_empty"), (n = e.options.translation.makeImageOpaque))
          : ((o = "opacity"), (n = e.options.translation.makeImageTransparent)),
          ((i = i || {}).toolbarIcon = {
            svg: !0,
            html: o,
            tooltip: n,
  ...
  function (t, e) {
    L.RestoreAction = L.EditAction.extend({
      ...
      addHooks: function () {
        var t = this._overlay;
        L.DomEvent.on(t, { edit: this._enableAction, restore: this._disableAction }, this),
          t.restore();
      },
    });
  },
  ...
  function (t, e) {
    (L.DistortableImage = L.DistortableImage || {}),
      ...
      (L.DistortableImage.PopupBar = L.Toolbar2.Popup.extend({
        options: { anchor: [0, -10] },
        initialize: function (t, e) {
          L.setOptions(this, e), L.Toolbar2.Popup.prototype.initialize.call(this, t, e);
        },
    ...
    (L.distortableImage = L.DistortableImage || {}),
      ...
      L.DistortableCollection.addInitHook(function () {
        (this.ACTIONS = [L.ExportAction, L.DeleteAction, L.LockAction, L.UnlockAction]),
          (L.DistortableCollection.Edit.MODES = { lock: L.LockAction, unlock: L.UnlockAction });
        var t = this.options.actions ? this.options.actions : this.ACTIONS;
  ...
  function (t, e) {
    (L.DistortableImage = L.DistortableImage || {}),
      (L.DistortableImage.Edit = L.Handler.extend({
        options: { opacity: 0.7, outline: "1px solid red", keymap: L.distortableImage.action_map },
        initialize: function (t, e) {
          (this._overlay = t),
        ...
        disable: function () {
          return this._enabled
            ? (this._overlay.deselect(), (this._enabled = !1), this.removeHooks(), this)
            : this;
        },
        _initModes: function () {
                ...
                if (o === t) {
                  ...
                  L.DistortableImage.Edit.MODES))
                    L.DistortableImage.Edit.MODES[a] === t
                      ...
                      : L.DistortableImage.Edit.MODES[a] === e && (i._modes[a] = e);
                  return !0;
                }
              }),
            this
          ...
          return (
            this.editActions.some(function (i, o) {
              if (i === t) {
                ...
                e._addToolbar(),
                L.DistortableImage.Edit.MODES))
                  L.DistortableImage.Edit.MODES[n] === t && (delete e._modes[n], e._nextOrNone(n));
                return !0;
              }
            }),
            this._overlay.isSelected() || this._removeToolbar(),
        ...
        _nextOrNone: function (t) {
          this.isMode(t) &&
            (Object.keys(this.getModes()).length >= 1
              ? this.nextMode()
              : ("lock" === t && this._enableDragging(), (this._mode = ""), this._updateHandle()));
        },
          ...
          (this.dragging = new L.Draggable(e.getElement())),
            ...
            (this.dragging._updatePosition = function () {
              ...
              for (this.fire("predrag"), o = 0; o < 4; o++)
                (t = i.latLngToLayerPoint(e.getCorner(o))), (s[o] = i.layerPointToLatLng(t.add(a)));
        ...
        _removeOverlay: function () {
          ...
          !this.isMode("lock") &&
            ...
            (this._removeToolbar(), e ? e.removeLayer(t) : t._map.removeLayer(t));
        },
        _getExport: function () {
          var t = this._overlay,
            e = t._map,
        ...
        _stackUp: function () {
          this._toggledImage &&
            ...
            ((this._toggledImage = !1), this._overlay.bringToFront(), this._refresh());
        },
        _stackDown: function () {
          !this._toggledImage &&
            this.hasTool(L.StackAction) &&
            ((this._toggledImage = !0), this._overlay.bringToBack(), this._refresh());
        },
        _unlock: function () {
          var t = this._overlay,
            e = t._map,
        ...
        _updateToolbarPos: function () {
          ...
          if (i && i instanceof L.DistortableImage.PopupBar) {
            ...
            var a = t.getCenter();
            (a.lat = o), t.options.suppressToolbar || this.toolbar.setLatLng(a);
          }
        },
        hasMode: function (t) {
        ...
        addHooks: function () {
          ...
          (this.editActions = this.options.actions),
            (this.runExporter = L.bind(
              L.Utils.getNestedVal(this, "_exportOpts", "exporter") || this.startExport,
              this
            )),
        ...
        _decollectAll: function (t) {
          ...
          t && (e = t.originalEvent),
            (e && (e.shiftKey || e.target instanceof HTMLImageElement)) ||
              (this._group.eachLayer(function (t) {
                L.DomUtil.removeClass(t.getElement(), "collected"), t.deselect();
              }),
              this._removeToolbar(),
              t && L.DomEvent.stopPropagation(t));
        },
          ...
          this.hasTool(L.LockAction) &&
            this._group.eachLayer(function (e) {
              t._group.isCollected(e) &&
                (e.editing._lock(), L.DomUtil.addClass(e.getElement(), "collected"));
            });
        },
        _addCollections: function (t) {
          ...
          this._group.eachLayer(function (t) {
            ...
            (r = o._latLngBoundsToNewLayerBounds(r, a, s)),
              i.intersects(r) &&
                n.enabled() &&
                (e.toolbar || e._addToolbar(), L.DomUtil.addClass(t.getElement(), "collected"));
          });
        },
        ...
        addTool: function (t) {
          return (
            "leaflet-toolbar-icon" !== t.baseClass ||
              this.hasTool(t) ||
              (this._removeToolbar(), this.editActions.push(t), this._addToolbar()),
            this
          );
        },
        removeTool: function (t) {
          ...
          return (
            this.editActions.some(function (i, o) {
              return (
                e.editActions[o] === t &&
                (e._removeToolbar(), e.editActions.splice(o, 1), e._addToolbar(), !0)
              );
            }),
            this
          );
        ...
        startExport: function () {
          ...
          if (this.hasTool(L.ExportAction))
            return new Promise(function (e) {
              var i,
                o = t._exportOpts;
              (o.resolve = e), (t.updateInterval = null);
                ...
                (o.updater =
                  ...
                  function (n) {
                    (n = JSON.parse(n)).status_url &&
                      (i !== n.status_url && n.status_url.match(".json") && (i = n.status_url),
                      "complete" === n.status &&
    ...
    (L.DomUtil = L.DomUtil || {}),
      ...
      (L.DistortableImage.Keymapper = L.Handler.extend({
        ...
        _wrap: function () {
          ...
          return t.setAttribute("id", "keymapper-wrapper"), (t.style.display = "none"), t;
        },
        ...
        _toggleKeymapper: function (t) {
          t.preventDefault(),
            ...
            (this._scrollWrapper.style.display =
              "none" === this._scrollWrapper.style.display ? "block" : "none"),
            (this._toggler.innerHTML =
              "close" === this._toggler.innerHTML ? L.IconUtil.create("keyboard_open") : "close"),
      ...
      L.DistortableImage.Keymapper.addInitHook(function () {
        (L.DistortableImage.Keymapper.prototype._n = L.DistortableImage.Keymapper.prototype._n
          ? L.DistortableImage.Keymapper.prototype._n + 1
          : 1),
          1 !== L.DistortableImage.Keymapper.prototype._n ||
            L.Browser.mobile ||
            (this.enable(), this._injectIconSet());
      }),
  ...
  function (t, e) {
    L.Map.DoubleClickZoom.include({
      ...
      enable: function () {
        return (
          this._enabled ||
            (this._map.doubleClickLabels && this._map.doubleClickLabels.enabled()) ||
            (this._map.fire("singleclickon"), (this._enabled = !0), this.addHooks()),
          this
        );
      },
      disable: function () {
        return this._enabled
          ? (this._map.fire("singleclickoff"), (this._enabled = !1), this.removeHooks(), this)
          : this;
      },
      _fireIfSingle: function (t) {
        ...
        (i && i.shiftKey) ||
          ...
          (this._map._clickTimeout = setTimeout(function () {
            1 === e._clicked
              ? ((e._clicked = 0), e.fire("singleclick", { type: "singleclick" }))
              : L.Browser.touch &&
                i &&
  ...
  function (t, e) {
    L.Map.include({
      ...
      _addLabels: function (t) {
        return (
          0 !== t.labelOpacity && 1 !== t.labelOpacity && (t.labelOpacity = 1),
